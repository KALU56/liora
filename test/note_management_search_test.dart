...
void main() {
  ...
  group('Issue #2 — Note Management & Title Search QA Gate', () {
    testWidgets(
      'Test 5 — Rename Note: Renaming updates title in Library and Editor',
      (WidgetTester tester) async {
        ...
        await tester.enterText(
          find.byKey(const Key('rename_note_input')),
          'Renamed Biology Note',
        );
        await tester.pumpAndSettle();
        ...
        expect(
          repository.getNoteById(note.id)?.title,
          equals('Renamed Biology Note'),
        );
      },
    );

    testWidgets(
      'Test 6 — Open Correct Note: Tapping a note opens its corresponding content',
      (WidgetTester tester) async {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // Type "bio"
        await tester.enterText(
          find.byKey(const Key('search_notes_field')),
          'bio',
        );
        await tester.pumpAndSettle();
