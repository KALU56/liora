...
void main() {
  group('Issue #5 — Digital Writing Tools QA Gate', () {
    testWidgets('Test 27 — Pen Tool Activation: Pen activates and default settings apply', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Pen Test Note'),
        ),
      );
      ...
      final canvasFinder = find.byKey(const Key('handwriting_touch_listener'));
      ...
      expect(canvasWidget.strokes.first.toolType, equals(WritingToolType.pen));
    });

    testWidgets('Test 28 — Pen Color Customization: Changing color updates stroke color', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Color Test Note'),
        ),
      );
      await tester.pumpAndSettle();
      ...
      expect(canvasWidget.strokes.first.color.value, equals(Colors.blue.value));
    });

    testWidgets('Test 29 — Pen Stroke Thickness: Thickness updates strokeWidth', (
      WidgetTester tester,
    ) async {
      const config = ToolConfig(toolType: WritingToolType.pen, strokeWidth: 10.0);
      expect(config.strokeWidth, equals(10.0));
    });

    testWidgets('Test 30 — Pen Opacity: Opacity setting applies to new strokes', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Test 31 — Pen Presets: Fine Pen & Marker presets update properties', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Presets Test Note'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('Test 32 — Pencil Tool Visual Style: Distinct pencil toolType and texture', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Pencil Test Note'),
        ),
      );
      await tester.pumpAndSettle();
      ...
      expect(canvasWidget.strokes.last.toolType, equals(WritingToolType.pencil));
    });

    testWidgets('Test 33 — Tool Switching: Switches cleanly between Pen and Pencil', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Tool Switch Note'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('Test 34 — Highlighter Tool Semi-Transparency: Renders with translucency', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
      ...
      expect(canvasWidget.strokes.last.toolType, equals(WritingToolType.highlighter));
      expect(canvasWidget.strokes.last.opacity, equals(0.4));
    });

    testWidgets('Test 35 — Highlighter Color Selection: Yellow highlighter color', (
      WidgetTester tester,
    ) async {
      ...
      expect(config.color.value, equals(const Color(0xFFFFEB3B).value));
    });

    testWidgets('Test 36 — Highlighter Text Readability: Preserves content visibility', (
      WidgetTester tester,
    ) async {
      final stroke = Stroke(
        id: 'hl_1',
    ...
    testWidgets('Test 37 — Highlighter Tool Switching: Switches cleanly with Pen', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
    ...
    testWidgets('Test 38 — Eraser Tool Size Selection: Small & Large sizes update radius', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Eraser Size Note'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('Test 39 — Eraser Object-Based Erasing: Erases target stroke cleanly', (
      WidgetTester tester,
    ) async {
      final stroke1 = Stroke(
        id: 's1',
        points: [
          TouchPoint(offset: const Offset(100, 100), timestamp: DateTime.now()),
          TouchPoint(offset: const Offset(120, 100), timestamp: DateTime.now()),
        ],
      );
      ...
      final stroke2 = Stroke(
        id: 's2',
        points: [
          TouchPoint(offset: const Offset(300, 300), timestamp: DateTime.now()),
          TouchPoint(offset: const Offset(320, 300), timestamp: DateTime.now()),
        ],
      );
    ...
    testWidgets('Test 40 — Eraser Continuous Drag Erasing: Removes intersected strokes along path', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: NoteEditorScreen(title: 'Drag Erase Note'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('Test 41 — Eraser Selective Isolation: Untouched independent strokes remain intact', (
      WidgetTester tester,
    ) async {
      ...
      final strokeDelete = Stroke(
        id: 'delete_me',
        points: [
          TouchPoint(offset: const Offset(200, 200), timestamp: DateTime.now()),
        ],
      );
