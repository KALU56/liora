  ...
  group('Issue #3 — Paper Template Engine & Customization QA Gate', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(body: PaperCanvasWidget(template: template)),
          ),
        );
        ...
        final PaperCanvasWidget widget = tester.widget(
          find.byType(PaperCanvasWidget),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        PaperCanvasWidget canvasWidget = tester.widget(
          find.byKey(const Key('paper_canvas')),
        );
        expect(
          canvasWidget.template.orientation,
          equals(PageOrientation.portrait),
        );
        ...
        expect(
          canvasWidget.template.orientation,
          equals(PageOrientation.landscape),
        );
